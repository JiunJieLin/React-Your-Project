const AddProject = ({ onStartAdd, projects, onSelected }) => {
  return (
      ...
      <ul>
        {projects.map((project) => {
          return (
            <li key={project.id}>
              <button
                className="my-1 w-full rounded-sm px-2 py-2 text-left text-2xl text-stone-400 hover:bg-stone-800 hover:text-stone-200"
